...
import { Box, Button, Divider, FormControl, FormHelperText, Heading, Input, InputGroup, InputRightElement, Stack, Text } from '@chakra-ui/react'
...
export const RegisterForm = () => {
  ...
  const onSubmit: SubmitHandler<Inputs> = async(data) => {
    ...
    console.log("環境変数:", process.env.NEXT_PUBLIC_API_KEY)
